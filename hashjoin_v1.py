...
def probe_and_filter_orders(redis_conn2, user_id, user_data, comparison_counter):
    ...
    for order_key in order_keys:
        ...
        if order_data_decoded and order_data_decoded['user_id'] == user_id:  # check if order_data contain user_id
...
def pipelined_hash_join(redis_conn1, redis_conn2):
    ...
    for user_key in user_keys:
        ...
        if user_data:
            ...
            probe_and_filter_orders(redis_conn2, user_key.decode('utf-8'), user_data_decoded, comparison_counter)
